...
var isString = utility_1.default.isString;
...
var failedResponse = String(fs_1.readFileSync('./test/misc/failed_response.xml'));
var createTemplateCallback = function (_idp, _sp, user) { return function (template) {
    var _id = '_8e8dc5f69a98cc4c1ff3427e5ce34606fd672f91e6';
    var now = new Date();
    var spEntityID = _sp.entityMeta.getEntityID();
    var idpSetting = _idp.entitySetting;
...
var oneloginIdpConfig = {
    privateKey: fs_1.readFileSync('./test/key/idp/privkey.pem'),
    privateKeyPass: 'q9ALNhGT5EhfcRmp8Pg7e9zTQeP2x1bW',
    isAssertionEncrypted: true,
    encPrivateKey: fs_1.readFileSync('./test/key/idp/encryptKey.pem'),
    encPrivateKeyPass: 'g7hGcRmp8PxT5QeP2q9Ehf1bWe9zTALN',
    metadata: fs_1.readFileSync('./test/misc/idpmeta_onelogoutservice.xml'),
};
var defaultSpConfig = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, t.throwsAsync(function () { return idp.createLoginResponse(sp, {}, 'undefined', user, createTemplateCallback(idp, sp, user)); })];
            case 1:
                error = _a.sent();
...
ava_1.default('create logout request when idp only has one binding', function (t) {
    var testIdp = identityProvider(oneloginIdpConfig);
    var _a = sp.createLogoutRequest(testIdp, 'redirect', { logoutNameID: 'user@esaml2' }), id = _a.id, context = _a.context;
    isString(id) && isString(context) ? t.pass() : t.fail();
});
...
ava_1.default('send response with signed assertion + custom transformation algorithms and parse it', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var signedAssertionSp, user, _a, id, SAMLResponse, _b, samlContent, extract;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                signedAssertionSp = serviceProvider(__assign({}, defaultSpConfig, { transformationAlgorithms: [
                        'http://www.w3.org/2000/09/xmldsig#enveloped-signature',
                        'http://www.w3.org/2001/10/xml-exc-c14n#'
                    ] }));
                user = { email: 'user@esaml2.com' };
                return [4 /*yield*/, idpNoEncrypt.createLoginResponse(signedAssertionSp, sampleRequestInfo, 'post', user, createTemplateCallback(idpNoEncrypt, sp, user))];
            case 1:
                _a = _c.sent(), id = _a.id, SAMLResponse = _a.context;
                return [4 /*yield*/, sp.parseLoginResponse(idpNoEncrypt, 'post', { body: { SAMLResponse: SAMLResponse } })];
            case 2:
...
ava_1.default('avoid malformatted response', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var user, SAMLResponse, rawResponse, attackResponse, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, sp.parseLoginResponse(idpNoEncrypt, 'post', { body: { SAMLResponse: utility.base64Encode(attackResponse) } })];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
...
ava_1.default('should reject signature wrapped response - case 1', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var user, _a, id, SAMLResponse, buffer, xml, stripped, outer, xmlWrapped, wrappedResponse, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = { email: 'user@esaml2.com' };
...
ava_1.default('should reject signature wrapped response - case 2', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var user, _a, id, SAMLResponse, buffer, xml, stripped, outer, xmlWrapped, wrappedResponse, result, e_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = { email: 'user@esaml2.com' };
            ...
            case 4:
                e_3 = _b.sent();
                t.is(e_3.message, 'ERR_POTENTIAL_WRAPPING_ATTACK');
                return [3 /*break*/, 5];
            case 5: return [2 /*return*/];
        }
    });
}); });
ava_1.default('should throw two-tiers code error when the response does not return success status', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var _result, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, sp.parseLoginResponse(idpNoEncrypt, 'post', { body: { SAMLResponse: utility.base64Encode(failedResponse) } })];
            case 1:
                _result = _a.sent();
                return [3 /*break*/, 3];
            case 2:
                e_4 = _a.sent();
                t.is(e_4.message, 'ERR_FAILED_STATUS with top tier code: urn:oasis:names:tc:SAML:2.0:status:Requester, second tier code: urn:oasis:names:tc:SAML:2.0:status:InvalidNameIDPolicy');
                return [3 /*break*/, 3];
