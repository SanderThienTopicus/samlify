    ...
    */
    ...
    ava_1.default('encrypt assertion test passes', function (t) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, t.notThrowsAsync(function () { return libsaml.encryptAssertion(idp, sp, sampleSignedResponse); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    ava_1.default('encrypt assertion response without assertion returns error', function (t) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, t.throwsAsync(function () { return libsaml.encryptAssertion(idp, sp, wrongResponse); })];
                case 1:
                    error = _a.sent();
    ...
    ava_1.default('encrypt assertion with invalid xml syntax returns error', function (t) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, t.throwsAsync(function () { return libsaml.encryptAssertion(idp, sp, 'This is not a xml format string'); })];
                case 1:
                    error = _a.sent();
                    t.is(error.message, 'ERR_MULTIPLE_ASSERTION');
                    return [2 /*return*/];
    ...
    ava_1.default('encrypt assertion with empty string returns error', function (t) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, t.throwsAsync(function () { return libsaml.encryptAssertion(idp, sp, ''); })];
                case 1:
                    error = _a.sent();
    ...
    ava_1.default('encrypt assertion with undefined string returns error', function (t) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, t.throwsAsync(function () { return libsaml.encryptAssertion(idp, sp, undefined); })];
                case 1:
                    error = _a.sent();
                    t.is(error.message, 'ERR_UNDEFINED_ASSERTION');
                    return [2 /*return*/];
    ...
    ava_1.default('building attribute statement with one attribute', function (t) {
        ...
        var expectedStatement = '<saml:AttributeStatement><saml:Attribute Name="email" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic"><saml:AttributeValue xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="xs:string">{attrUserEmail}</saml:AttributeValue></saml:Attribute></saml:AttributeStatement>';
    ...
    ava_1.default('building attribute statement with multiple attributes', function (t) {
        ...
        var expectedStatement = '<saml:AttributeStatement><saml:Attribute Name="email" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic"><saml:AttributeValue xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="xs:string">{attrUserEmail}</saml:AttributeValue></saml:Attribute><saml:Attribute Name="firstname" NameFormat="urn:oasis:names:tc:SAML:2.0:attrname-format:basic"><saml:AttributeValue xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="xs:string">{attrUserFirstname}</saml:AttributeValue></saml:Attribute></saml:AttributeStatement>';
        t.is(libsaml.attributeStatementBuilder(attributes), expectedStatement);
    });
})();
(function () {
    ...
    ava_1.default('sp metadata with shibboleth elements order', function (t) {
        var spToShib = serviceProvider(Object.assign({}, baseConfig, { elementsOrder: ref.elementsOrder.shibboleth }));
