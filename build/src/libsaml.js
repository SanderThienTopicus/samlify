                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!validate) {
                                ...
                                return [2 /*return*/, Promise.reject('Your application is potentially vulnerable because there is no validation function is found. Please read the documentation on how to setup the validator. (https://samlify.js.org/#/schema-validator)')];
                            }
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
