 ...
 * @param arr2 {[]}
 */
export declare function zipObject(arr1: string[], arr2: any[]): {};
/**
...
*/
declare function base64Encode(message: string): string;
/**
...
*/
declare function deflateString(message: string): string;
/**
